...
From `r n_enrolled` participants, `r n_hiv` (`r round(n_hiv/n_enrolled*100, 1)`%) women were HIV positive, meeting `r round(n_hiv/enrolled*100, 1)`% of our WLWH cohort enrollment target. Of these, `r six_weeks_postpartum` (`r round(six_weeks_postpartum/n_hiv *100,1 )`%) have completed their 6 week postpartum follow-up with our study team. Additionally, `r fourteen_weeks_postpartum` (`r round(fourteen_weeks_postpartum / n_hiv * 100, 1)`%) have completed their 14-week follow-up, and `r six_months_postpartum` (`r round(six_months_postpartum / n_hiv * 100, 1)`%) have completed their 6-month follow-up.
