...
```{r enrollment_sub, echo=FALSE, message=FALSE, warning=FALSE}
source("Enrollment Progress.R")
...
```{r consort_mortality,echo=FALSE, message=FALSE, warning=FALSE}
source("Consort_WLWH.R")
...
As of `r Sys.Date()`, `r total_aes` adverse events were reported. These will be included in the annual cumulative report to the ERC, in accordance with protocol requirements.
