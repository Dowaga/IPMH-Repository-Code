...
```{r, arm, echo=F, message=FALSE, warning=FALSE, including =F}
...
#Again, this is showing the there are two facility-in-charge for Gita Sub County Hospital (facility 14), caused by ID: 24140190
```
...
suveys_done
##pending 2 facility-in-charges from 03, Uyawi Sub County Hospital & 04, Got Agulu Sub-District Hospital	
```
