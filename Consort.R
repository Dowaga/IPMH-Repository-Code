...
txt_anc <- c("ANC Attendees (n=4,076)")
txt_ass <- c("Assessed for Eligibility\n (n=1,012, 24.83%)") 
txt_arm <- c("Control\n (n=521, 51.48%)", "Intervention\n (n=491, 48.52%)")
txt_ex_control <- "Excluded (n=193, 37.04%):\n\u2022 Gestation < 28 weeks (n=176, 91.19%)\n\u2022 Hearing voices that others cannot hear (n=3, 1.55%)\n\u2022 Holding unusual beliefs (n=4, 2.07%)\n\u2022 Memory problem (n=3, 1.55%)\n\u2022 Self harm (n=5, 2.59%)\n\u2022 Self harm and memory problem (n=2, 1.04%)"
