...
arm_groups <- unique(weekly_enrollment %>%
                       mutate(arm = stringr::str_extract(study_site,"^\\d{2}"),
                              arm_group = ifelse(arm %in% c("05", "06", "08", "11", "14", "15", "18", "20", "22"),
