...
We began recruiting pregnant women into the study on Feb 17, 2025. `r n_enrol` participants have been recruited into the study, meeting `r round(n_enrol/2970 *100, 1)`% of our enrollment target. Of these, `r n_second` (`r n_second_per`%) have completed their 6 week postpartum follow-up, `r n_third` (`r n_third_per`%) and `r n_fourth` (`r n_fourth_per`%) have completed 14 weeks and 6 months postpartum follow-up respectively.
...
txt_arm <- counts_by_arm %>%
    mutate(
        txt = sprintf("%s\n (n=%d, %.2f%%)", dummy_arm, assessed, (assessed / n_assessed) * 100)
    ) %>%
    pull(txt)
