...
Altogether, we currently have data for  `r sum(data$redcap_event_name == "survey_arm_2")` participants.
...
data %>% 
    ...
    select(dx_provision, dx_hiv,  dx_way___1,  dx_way___2,  dx_way___3, 
           ...
           trt_diff_couns,  trt_hiv_other, trt_med_hiv___1,  trt_med_hiv___2, 
    ...
    tbl_summary(missing = "no",
         ...
         label = list(
            ...
            trt_diff_couns ~ "Different types of manualized counselling among PWLHIV",
             trt_hiv_other ~ "Other types of treatment different among PWLHIV",
...
stats <- stats %>% 
  mutate(barrier_detail = dplyr::recode(barrier, 
                                        ...
                                        "staff" = "Staff: Shortage of staff",
                                        "incentive" = "Incentive: Lack of financial incentives to motivate HCW",
                                        "flow" = "Cumbersome flow from pming to diagnosis\n to getting PM+ leading to loss of patients",
...
stats <- stats %>% 
  mutate(barrier_detail = dplyr::recode(barrier, 
                                        "sche" = "Sche: Scheduling process of telepsychiatry",
                                        ...
                                        "port" = "Port: Portability of the gadgets used for telepsychiatry",
                                        ...
                                        "language" = "Language: Language barrier between women and HCWs",
                                        "confi" = "Confi: Fear of breach of confidentiality",
                                        "physical" = "Clients unwillingness to talk to psychiatrist \n over the online platform as opposed to in-person"))
...
stats <- stats %>% 
  mutate(strategy_detail = dplyr::recode(strategy, 
                                         "align" = "Align: Align psychiatry appointment with routine clinic visits",
