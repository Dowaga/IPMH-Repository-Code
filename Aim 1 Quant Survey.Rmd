...
#read data
data <- read.csv("~/Desktop/uw/IPMH/data analysis/IPMHAim1Quantitative_DATA_2024-07-12_0007.csv")
```
...
stats <- stats %>% 
  mutate(barrier_detail = dplyr::recode(barrier, 
                                        ...
                                        "confi" = "Confi: Fear of breach of confidentiality",
                                        "physical" = "Physical: Clients unwillingness to talk to psychiatrist \n over the online platform as opposed to in-person"))
