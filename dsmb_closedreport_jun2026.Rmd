...
completed_control <- total_exits %>% 
    ...
    select(clt_ptid, clt_visit, hiv_care_and_treatment_complete) %>% 
    filter(clt_visit=="6 months post-partum" & hiv_care_and_treatment_complete== "Complete") %>%
    nrow()
...
invisible(capture.output(source("PPW RCT follow up.R")))
```
>>>>>>> bddf7ea1de976540575361ae7a255a8bb96be3db
...
<<<<<<< HEAD
```{r Outcome summary, echo=FALSE}
 arm_outcome_summary %>% as_kable_extra(booktabs = TRUE, longtable = FALSE) %>%
    kableExtra::kable_styling(latex_options = c("hold_position", "scale_down"),
        full_width = TRUE
    )
=======
```{r Outcome summary, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
 arm_outcome_summary %>% as_kable_extra(booktabs = TRUE, longtable = FALSE, escape = FALSE) %>%
    kableExtra::kable_styling(latex_options = c("hold_position", "scale_down"),
        full_width = TRUE
    )
