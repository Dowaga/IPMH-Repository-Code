...
### Demographic Summary for Baseline [6/12 months needs to be added]

```{r, Basic Demographic Summary, echo=FALSE, message=FALSE, warning=FALSE}
## This is collected at baseline only - there will be newly added participants at the follow-up visits.
## Needs to fix after getting new demographic data.
...
culture_df <- culture_df %>% 
    mutate(across(starts_with("culture"), ~ case_when(
    ...
    mutate(across(starts_with("cstress"), ~case_when(
        . == "Strongly disagree" ~ 1,
        . == "Disagree" ~ 2,
        . == "Neutral" ~ 3,
        . == "Agree" ~ 4,
    ...
    mutate(across(starts_with("ceffort"), ~case_when(
        . == "Strongly disagree" ~ 1,
        . == "Disagree" ~ 2,
        . == "Neutral" ~ 3,
        . == "Agree" ~ 4,
...
# reverse coding for some items: culture_3, ceffort_5
culture_df <- culture_df %>%
    mutate(across(c(culture_3, ceffort_5),
                  ~6 - .)) 
