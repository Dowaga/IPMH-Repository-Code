...
```{r The Consort,echo=FALSE, fig.height=12, fig.width=15, message=FALSE, warning=FALSE}
source("Consort.R")
...
wrong_pm_survey <- pm_survey_df %>% 
    filter(pm_ptid%in% c(21177049, 21031052, 21010085, 21094053, 21073077, 21229516, 21198004, 21041517, 21229608))
```
