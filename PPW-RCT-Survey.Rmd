...
```{r The Consort, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=8}
source("Consort.R")
...
attendance_table %>%
  ...
  add_header_above(c("PM+ Session Tracking for Study Participants" = ncol(attendance_table))) %>%
  kableExtra::footnote(general_title = "Notes: ", general = "On time is defined as within a 14 day window since last attendance")
```
