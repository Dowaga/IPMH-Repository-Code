...
```{r The Consort, echo=FALSE, fig.height=9, fig.width=15, message=FALSE, warning=FALSE}
source("Consort.R")
...
# HEAD
    ...
    #  caption = "Summary of Follow-up Tracking by Facility")
# 1dacc39f1c7b2e1bb3d9caa0c5f28432e9db8843
...
demographics_df %>% tbl_summary(
    sort = list(all_categorical() ~ "frequency"),  # Sort categorical levels by frequency in descending order
    include=c(dem_age, med_pre_preg, med_num_preg,
              dem_current_partner, dem_maritalstat, dem_marriage, 
              dem_pc_residence, dem_current_school, dem_school,
    ...
    label = list(dem_age ~ "Age (Years)",
                 ...
                 med_pre_preg ~ "Ever been pregnant (Yes)",
                 med_num_preg ~ "Total Pregnancies (incl.current)"),
    missing = "no",
