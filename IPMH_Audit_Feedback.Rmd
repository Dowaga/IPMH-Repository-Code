...
# 1. PHQ2 and GAD2 Screening Rate Per Facility (Per month & July-September Combined)
...
kable(total_screening_rate, 
      caption = "July-September Combined PHQ2/GAD2 Screening Rate by Facility",
      digits = 2)
```

\newpage

# 2. PHQ9 and GAD7 Screening Rate Among New Study Participants Per Facility (Per month & July-September Combined)
...
kable(phq9_screening_total, 
      caption = "July-September Combined PHQ9/GAD7 Screening Rate by Facility (for new participants)",
      digits = 2)
```

\newpage

# 3. PM+ Referral Rate Per Facility (Per month & July-September Combined)
...
kable(pm_referral_total,
      caption = "July-September Combined PM+ Referral Rate by Facility",
      digits = 2)
```

\newpage

# 4. Telepsychiatry Referral Rate Per Facility (Per month & July-September Combined)
...
kable(total_referral_summary_tele, caption = "July-September Combined Telepsychiatry Referral Rate by Facility",
      digits = 2)
```

\newpage

# 5. PM+ initiation rate per facility (Per month & July-September Combined)
...
kable(pm_initiation_all_merge_session1,
      caption = "July-September Combined PM+ Initiation Rate by Facility",
      digits = 2)
```
\newpage
...
# 7. Telepsychiatry initiation rate per facility (Per month & July-September Combined)
...
kable(telepsych_initiation_total,
      caption = "July-September Combined Telepsychiatry Initiation Rate by Facility",
      digits = 2)
```

\newpage

# 8. Frequency of conducting health talks & use of flipbook per facility (Per month & July-September Combined)

```{r health talks, echo = F, warning=F}
kable(health_talks_monthly, caption = "Monthly Health Talks & Flipbook Usage by Facility",
      digits = 2)
kable(total_health_talks, caption = "July-September Combined Health Talks & Flipbook Usage by Facility",
      digits = 2)
```
