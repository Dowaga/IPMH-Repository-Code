...
# 2. PHQ9 and GAD7 Screening Rate Among Study Participants Per Facility (Per month & July-September Combined)
...
for (facility in facilities) {
  ...
  p <- ggplot(facility_data, aes(x = week, y = `PHQ9/GAD7 screening rate`, color = redcap_event_name)) +
    geom_line() + 
    geom_point() +
...
kable(phq9_screening_total, 
      caption = "July-September Combined PHQ9/GAD7 Screening Rate by Facility",
      digits = 2)
```
