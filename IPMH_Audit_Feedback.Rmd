...
This script generates the audit and feedback report for each facility based on the calendar months. For the fifth audit and feedback session, we will report statistics from March 1st to May 31st. Data from the report should be abstracted for each facility and put into the slide template.
...
# 2. PHQ9 and GAD7 Screening Rate Among New Study Participants Per Facility (Per month & March - May Combined)
...
kable(phq9_screening_total, 
      caption = "March - May Combined PHQ9/GAD7 Screening Rate by Facility (for new participants)",
      digits = 2)
```
