...
This script generates the audit and feedback report for each facility based on the calendar months. For the third audit and feedback session, we will report statistics from Sept 1st to Nov 31st. Data from the report should be abstracted for each facility and put into the slide template.
