...
ppw_rct_df <- read.csv(file.path(ipmh_filepath, "/Data/6. RCT PPW data/RCT_PPW_2025-03-10.csv")) %>% 
    filter(is.na(redcap_repeat_instance))

screening_consent_df <- read.csv(file.path(ipmh_filepath, "/Data/2. Consenting database/RCT_PPW_consenting_2025-03-10.csv")) 

pm_survey_df <- read.csv(file.path(ipmh_filepath, "Data/7. RCT admin data/PM_2025-03-10.csv"))

daily_closeout_df <- read.csv(file.path(ipmh_filepath, "Data/7. RCT admin data/Daily_closeout_2025-03-10.csv"))
...
#colnames(pm_session_wide) <- c("ptid", paste0("Session_", colnames(pm_session_wide)[-1]))

pm_session_wide %>% 
    tbl_summary(include = c(facility, `Pre-intervention PSYCHLOPS measurement`, `Session 1`),
